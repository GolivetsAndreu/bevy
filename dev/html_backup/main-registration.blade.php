...
<head>
    ...
    <title>Broome | Регистрация</title>
        ...
        <div class="reg-main__inner d-flex justify-content-between align-items-center">
            <div class="reg-main__left d-flex align-items-center">
                <div class="reg-main__left-inner text-center m-auto" id="reg_step_1">
                    ...
                    <form class="reg-main__form" method="POST" id="form">
                        <div class="reg-main__form-inner d-flex justify-content-center flex-column">
                            <div class="d-flex justify-content-center flex-column reg-main__form-block">
                                <input id="user_name" type="text" class="reg-main__login reg-main__input" name="name" placeholder="Имя">
                                <span class="input_error name"></span>
                            </div>
                            <div class="d-flex justify-content-center flex-column reg-main__form-block">
                                <input id="user_surname" type="text" class="reg-main__pass reg-main__input" name="surname" placeholder="Фамилия">
                                <span class="input_error surname"></span>
                            </div>
                            <div class="d-flex justify-content-center flex-column reg-main__form-block">
                                <input type="text" id="reg_login" class="reg-main__pass reg-main__input" name="login" placeholder="Логин">
                                <span class="input_error login"></span>
                            ...
                            <div class="d-flex justify-content-center flex-column reg-main__form-block relative">
                                <input id="user_password" type="password" class="reg-main__pass reg-main__input" name="password" placeholder="Пароль">
                                <span class="input_error password"></span>
                                <i class="fa fa-eye absolute"></i>
                            </div>
                            <div class="d-flex justify-content-center flex-column reg-main__form-block relative">
                                <input id="user_password_repeat" type="password" class="reg-main__pass reg-main__input" name="repeat_password" placeholder="Повторите пароль">
                        ...
                        <button id="reg_button" class="reg-main__btn" type="button">Зарегистрироваться</button>
                ...
                <div class="reg-main__left-inner text-center m-auto" id="reg_step_2">
                    ...
                    <form class="reg-main__form" method="POST" id="form_code">
                        ...
                        <div class="reg-main__registered">
                            <span>Уже зарегестрированы? </span><a href="/logIn">Войти.</a>
                        </div>
                    </form>
                </div>
            </div>
