                            ...
                            <div class="settings__content">
                                <div class="settings__content-item">
                                    <div class="settings__content-item-heading">
                                        <h3>1) Смена пароля</h3>
                                    </div>
                                    <div class="settings__content-item-content">
                                        <form id="settings_form" name="settings-form" method="POST" action="">
                                            ...
                                            <div class="settings__content-item-content-save-pas">
                                                <button type="button" id="save_new_pass">Сохранить пароль</button>  
                                            </div>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="settings__content-item">
                                    ...
                                    <div class="settings__content-item-content d-flex align-items-end">
                                        <div class="settings__content-item-content-del-wrapper d-flex align-items-center flex-wrap">
                                            <div>
                                                <a href="#">Удалить мою учетную запись</a>
                                            </div>
                                            <div class="settings__content-item-content-del-wrapper-confirm d-flex align-items-center">
                                                <input type="checkbox" id="confirm_del_acc" name="confirm_del_acc">
                                                <label for="confirm_del_acc">Подтверждаю удаление аккаунта</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
