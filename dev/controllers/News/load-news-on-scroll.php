<?php
    ...
    //get friends posts
    $get_news = "SELECT * FROM user_posts WHERE user_id='$user_id' OR user_id IN(SELECT idFriend FROM friends WHERE idUser='$user_id') ORDER BY id DESC LIMIT $start_from, 10";
